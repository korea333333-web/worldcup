(function addWorldCupSchedule() {
  ...
  data.matchSchedule = {
    ...
    sourceNote: "FIFA 공식 일정 페이지를 기준으로 시작하되, 현재 앱의 가상 조 편성과 연결되는 일부 경기는 시나리오 일정으로 표시합니다.",
    sources: [
      {
        id: "fifa-schedule",
    ...
    matches: [
      ...
      match(2, "Group A", "2026-06-12", "18:00", "2026-06-13 10:00", "vancouver", "korea", "norway", "scenario", "앱 조편성 시나리오"),
      ...
      match(8, "Group A", "2026-06-17", "15:00", "2026-06-18 06:00", "guadalajara", "korea", "mexico", "scenario", "대한민국 핵심 경기"),
      match(9, "Group A", "2026-06-18", "12:00", "2026-06-19 03:00", "monterrey", "south-africa", "norway", "scenario", "3위 경쟁권 경기"),
      match(10, "Group A", "2026-06-23", "20:00", "2026-06-24 12:00", "vancouver", "korea", "south-africa", "scenario", "조별 최종전"),
      match(11, "Group A", "2026-06-23", "20:00", "2026-06-24 11:00", "mexico-city", "mexico", "norway", "scenario", "조별 최종전"),
